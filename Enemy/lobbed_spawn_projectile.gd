## Lobbed projectile fired in a ballistic arc that falls with gravity and spawns
## an enemy entity upon landing, with optional landing area damage.
## Reuses the same ballistic arc math and export var style as FirebombProjectile.
