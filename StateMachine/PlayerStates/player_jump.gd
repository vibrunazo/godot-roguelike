...
func physics_update(delta: float) -> void:
	...
	if character.knockback_component != null and character.knockback_component.is_active():
		...
		character.velocity.x = lerp(_launch_velocity.x, target_velocity.x, control_ratio)
		character.velocity.z = lerp(_launch_velocity.z, target_velocity.z, control_ratio)
